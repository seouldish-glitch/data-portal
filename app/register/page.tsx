      ...
      <div style={{
        ...
        <div style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '100%', maxWidth: '450px' }}>
            <h2 style={{ color: 'var(--sbc-white)', marginBottom: '2rem', fontSize: '1.8rem', fontFamily: "'Manrope', sans-serif", fontWeight: 700 }}>Register</h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div>
                <label style={{ display: 'block', fontSize: '0.95rem', fontWeight: 600, color: 'var(--sbc-white)', marginBottom: '0.5rem' }}>Full Name</label>
                <input 
                  type="text" 
                  value={name}
            ...
            <p style={{ textAlign: 'center', marginTop: '2rem', color: 'rgba(255,255,255,0.6)', fontSize: '0.9rem' }}>
              Already have an account? <Link href="/login" style={{ color: 'var(--sbc-white)', textDecoration: 'none', fontWeight: 600 }}>Sign In</Link>
            </p>
          </div>
        </div>
      </div>
